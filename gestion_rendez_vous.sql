...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 24 oct. 2021 à 13:00
...
INSERT INTO `user` (`id`, `nom_complet`, `login`, `password`, `role`, `statut`, `disponible`, `code`, `id_antecedent`, `id_consultation`, `id_rdv`) VALUES
(1, 'Hugues ADAISSO', 'login', '1234', 'ROLE_SECRETAIRE', NULL, NULL, '0', NULL, NULL, NULL),
(2, 'divine', 'divine', 'olafa', 'ROLE_MEDECIN', 'GENERALISTE', 1, 'AZE3456Y', NULL, NULL, NULL),
(3, 'ivan', 'maximilien', 'ivan', 'ROLE_PATIENT', NULL, NULL, '0', NULL, NULL, NULL),
(4, 'Jean', 'paul', 'jean', 'ROLE_RESPONSABLE', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'bezzber', 'reberzb', 'rezbrebezr', 'ROLE_PATIENT', NULL, NULL, 'zerrbrezrb', 1, NULL, NULL),
(6, 'Cindy ADOU', 'cindy', 'adou', 'ROLE_PATIENT', NULL, NULL, 'AZEAE2332', 1, NULL, NULL);
